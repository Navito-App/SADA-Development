...
$page = new admin_settingpage('theme_zuum_block', get_string('theme_zuum_frontpageblock', 'theme_zuum'));
...
// Block end.
$page->add(new admin_setting_heading('theme_zuum_blockend', "",
format_text(get_string('theme_zuum_frontpageblockenddesc', 'theme_zuum'), FORMAT_MARKDOWN)));
$settings->add($page);
